...
def buy():
    ...
    if request.method == "POST": 
        ...
        if lookup(request.form.get("symbol")) == None:
            return apology("Can't find this symbol")
...
def login():
    ...
    if request.method == "POST":
        ...
        if not request.form.get("username"):
            return apology("Enter username please")

        # ensure password was submitted
        elif not request.form.get("password"):
            return apology("Enter password please")
...
def register():
    ...
    if request.method == "POST": 
        ...
        if db.execute("SELECT * FROM users WHERE username = :username", username=request.form.get("username")):
            return apology("Sorry! This name is already taken:(")
...
def sell():
    ...
    if request.method == "POST": 
        ...
        if not request.form.get("amount"):
            return apology("Enter amount please")
